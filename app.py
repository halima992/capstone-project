  ...
  # create and configure the app
    ...
    def insert_actors(jwt):
        ...
        # if actor is unique post it
            ...
            # the exception could be happen if there is null coulmn may gender
            # , movie or  actor
    ...
    def insert_movies(jwt):
        ...
        # if movie is unique post it
            ...
            try:
                ...
                new_movie.insert()
                return jsonify({'success': True})
            # the exception could be happen if there is null coulmn may  movie
            # or  catogary
            except BaseException:
                abort(422)
